# MADAO CHAT — AI 面试助手
在当前 **ai** 盛行的背景下，应对 **ai**冲击的浪潮，针对  **ai -> 人**   ai面试官的出现，特推出   **人 -> ai**   面试助手帮助求职者完成ai应面............

基于 **RAG（检索增强生成）** 与 **LangGraph 多智能体** 的全栈 AI 面试辅助系统。支持面试官与面试者（暂不支持）两种角色，可上传简历、GitHub 仓库构建知识库，通过向量检索 + LLM 生成高质量面试问答，并具备 TTS 语音播报能力。
